...
# Allow-list of fm keys that don't trigger 'unknown key' warning. Required
# keys + commonly-used optional keys per spec §2.3 + project precedent.
# Generous by design; tighten in v1.2.
_ALLOWED_FM_KEYS = frozenset(_REQUIRED_FM_KEYS + (
    "version",
    "role",
    "audience",
    "dependencies",
