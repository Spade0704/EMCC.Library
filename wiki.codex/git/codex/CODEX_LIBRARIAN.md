...
canon_sources: ["CODEX_BUILD_SPEC_v1_4.md (Principle #10; spec basis; §9 Asset Registry incl. §9.9 visual-evidence + §9.10 base-identity)", "tasks/plans/portfolio-folder-structure-spec.md §(d) (Librarian Agent + Codex Scripts — Design)"]
unverified_claims: []
---
