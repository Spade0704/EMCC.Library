...
canon_sources: ["CODEX_BUILD_SPEC_v1_4.md (Principle #10; spec basis; §9 Asset Registry)", "tasks/plans/portfolio-folder-structure-spec.md §(d) (Librarian Agent + Codex Scripts — Design)"]
unverified_claims: []
---
