...
Codex (the wiki scaffolding sub-tool, spec at `CODEX_BUILD_SPEC_v1_2.md`) has one canonical persona — the **Librarian**. This doc defines it.
...
**Librarian.** Codex's curator and operations executor. Drives the three Codex operations defined in `CODEX_BUILD_SPEC_v1_2.md` §4:
