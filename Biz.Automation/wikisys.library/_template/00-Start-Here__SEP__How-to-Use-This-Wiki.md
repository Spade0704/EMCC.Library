...
This page explains how the `<Project Name>` wiki is organized, how to navigate it, and the conventions that pages follow. It is generic across projects scaffolded by Codex; minor customization is usually unnecessary.
...
When asking Claude (or another agent) a question about `<Project Name>`, follow the four rules in `_context/CLAUDE_CONTEXT_RULES.md` § "Question-Answering Behavior".
