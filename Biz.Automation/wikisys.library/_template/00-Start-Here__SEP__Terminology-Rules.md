---
title: "<Project Name> — Terminology Rules"
type: guide
visibility: internal
completion: 0
status: gap
...
# <Project Name> — Terminology Rules

This page documents `<Project Name>`-specific terminology policy: which terms are forbidden in which contexts, why, and how to use the escape hatch when a forbidden term is unavoidable.
